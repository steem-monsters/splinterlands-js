...
window.splinterlands.bsc = (function() {
	async function bscDeposit(amount, player) {
		...
		let contract = '0xe9d7023f2132d55cbd4ee1f78273cb7a3e74f10a';
		let contractObject = new web3.eth.Contract(get_DEC_BSC_ABI(), contract);
		let tokenAmount = amount * Math.pow(10, 3);
